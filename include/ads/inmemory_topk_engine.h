...
void calculate_node_topk_inmemory (isax_index *index, isax_node *node, ts_type *query, ts_type *paa_mbb,
                                   pqueue_bsf *pq_bsf);
void refine_topk_answer_inmemory (ts_type *ts, ts_type *paa, ts_type *paa_mbb, isax_index *index,
...
pqueue_bsf exact_topk_MESSImq_inmemory (ts_type *ts, ts_type *paa, ts_type *paa_mbb, isax_index *index,node_list *nodelist,
                           float minimum_distance, int min_checked_leaves,int k);
