...
query_result exact_search_serial_ParIS2_inmemory(ts_type *ts, ts_type *paa, ts_type *paa_mbb, isax_index *index,
                                                 float minimum_distance, int min_checked_leaves);
query_result exact_search_serial_ParIS_openmp_inmemory(ts_type *ts, ts_type *paa, ts_type *paa_mbb, isax_index *index,
                                                       float minimum_distance, int min_checked_leaves);
query_result exact_search_serial_ParGISG_openmp_inmemory(ts_type *ts, ts_type *paa, ts_type *paa_mbb,
                                                        isax_index *index, float minimum_distance, int min_checked_leaves);
query_result exact_search_serial_ParGIS_openmp_inmemory(ts_type *ts, ts_type *paa, ts_type *paa_mbb,
                                                        isax_index *index, float minimum_distance, int min_checked_leaves);
...
query_result exact_search_ParISnew_inmemory (ts_type *ts, ts_type *paa, ts_type *paa_mbb, isax_index *index,node_list *nodelist,
                           float minimum_distance, int min_checked_leaves);
query_result exact_search_ParISnew_inmemory_workstealing (ts_type *ts, ts_type *paa, ts_type *paa_mbb, isax_index *index,node_list *nodelist,
                           float minimum_distance, int min_checked_leaves);
query_result exact_search_MESSI (ts_type *ts, ts_type *paa, ts_type *paa_mbb, isax_index *index,node_list *nodelist,
                           float minimum_distance, int min_checked_leaves);

query_result exact_search_ParISnew_inmemory_hybrid_workstealing (ts_type *ts, ts_type *paa, ts_type *paa_mbb,
