#!/bin/sh
# messi+sax+simd
./bin/MESSI --dataset /glusterfs/dfs-gfs-dist/brandjak-pub/SCEDC.bin --in-memory --timeseries-size 256  --function-type 3 --SIMD --dataset-size 100000000 --flush-limit 300000 --read-block 20000 --sax-cardinality 8 --queries /glusterfs/dfs-gfs-dist/brandjak-pub/SCEDC_queries.bin   --queries-size 100 --queue-number 36 --cpu-type 362 --is-norm --leaf-size 20000 --min-leaf-size 20000 --initial-lbl-size 20000

# messi+sfa+best +ed
./bin/MESSI --dataset /glusterfs/dfs-gfs-dist/brandjak-pub/SCEDC.bin --in-memory --timeseries-size 256  --function-type 4 --dataset-size 100000000 --flush-limit 300000 --read-block 20000 --sax-cardinality 8 --queries /glusterfs/dfs-gfs-dist/brandjak-pub/SCEDC_queries.bin   --queries-size 100 --queue-number 36 --sample-size 1000000 --sample-type 3 --cpu-type 362 --is-norm --histogram-type 1 --leaf-size 20000 --min-leaf-size 20000 --initial-lbl-size 20000 --coeff-number 32
